...
const moduleName = 'Displacement TravelToPosition handler';

tape(
	`${moduleName}
	travelToPosition()
		GIVEN an entity and a State lacking this entity
		WHEN called with a request having the entity id`,
	(test: tape.Test) => {
		test.plan(3);
...
tape(
	`${moduleName}
	travelToPosition()
		GIVEN an entity and a State having this entity
		WHEN called with a request having the entity id`,
	(test: tape.Test) => {
		test.plan(3);
